      ...
      {ordersLoading ? (
        ...
        <>
          ...
          <div className="border divide-y rounded-lg">
            ...
            />
            <Field
              icon={<PurchasedIcon width={20} className="text-gray-700" />}
              title="Purchase"
              value={ordersData?.order?.orderDetails?.purchase}
            />
            <Field
          ...
          {ordersData?.order?.addOns?.map((item) => (
            <div key={item._id} className="my-3 divide-y border rounded-lg">
              ...
              <Field
                ...
                className2={"text-green-500"}
              />
              <Field title="MRP" value={item?.mrp} />
              <Field title="Descripton" value={item?.description} />
            </div>
          ))}
        </>
      )}
