        ...
        <div>
          ...
          <div className="mt-[30px] grid lg:grid-cols-3 xl:grid-cols-5 grid-cols-2 md:grid-cols-3 gap-5">
            ...
            <HomeCard
              ...
              isImage={false}
              amount={"$" + analyticsData?.orders?.totalPurchaseUsers?.amount}
            />
            <HomeCard
              title="Conversion"
          ...
          <div className="mt-[30px] grid lg:grid-cols-3 xl:grid-cols-5 grid-cols-2 md:grid-cols-3 gap-5">
            ...
            <HomeCard
              ...
              value={analyticsData?.orders?.refundData?.refundRequests?.count}
              isImage={false}
              amount={
            ...
            <HomeCard
              title="Total Refunds"
              value={
                analyticsData?.orders?.refundData?.totalRefundRequests?.count
              }
              isImage={false}
              amount={
                "$" +
                analyticsData?.orders?.refundData?.totalRefundRequests?.amount
              }
            />
            <HomeCard
              title="True Refunds"
          ...
          <div className="py-5">
            ...
            <DataTable
              ...
              classNameHeader={"bg-gray-100 py-2"}
            />
          </div>
          <div className="py-5">
            <h2 className="text-[20px] font-semibold pb-5">
            ...
            <DataTable
              data={planData?.userStatistics?.data?.userStatistics?.data || []}
